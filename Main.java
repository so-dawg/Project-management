...
public class Main {
  public static void main(String[] args) {
    ...
    IUser user1 = userRegistry.login("sarah.johnson@company.com", "Owner123@", userRegistry.getArrayList());
    if (user1 != null) {
    ...
    for (IUser u : userRegistry.getArrayList()) {
    ...
    for (Project p : pm.getAllProjects()) {
      System.out.println("ID: " + p.getProjectID() + " | " + p.getTitle() + " | Owner: " + p.getOwner().getFirstName()
