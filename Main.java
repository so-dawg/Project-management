...
public class Main {
  ...
  public static void testMemberClass() {
    ...
    System.out.println("Created member: " + member.getFirstName() + " " + member.getLastName());
    ...
    System.out.println("Updated name: " + member.getFirstName() + " " + member.getLastName());
    ...
    System.out.println("  valid@example.com: " + Member.isValidEmail("valid@example.com"));
    ...
    System.out.println("  nouppercase1!: " + Member.isValidPassword("nouppercase1!"));
    System.out.println("  NOLOWERCASE1!: " + Member.isValidPassword("NOLOWERCASE1!"));
  ...
  public static void testOwnerClass() {
    ...
    Member baseMember = new Member("Admin", "User", "admin@example.com", "admin", "Password123@");
    ...
    Task task = new Task("Test Task", Task.TaskPriority.HIGH, LocalDate.now().plusDays(7), "Test description");
    ...
    Task task2 = new Task("Task 2", Task.TaskPriority.MEDIUM, null, "Another task");
    ...
    Task task3 = new Task("Past Task", Task.TaskPriority.LOW, null, "Past deadline test");
  ...
  public static void testUserClass() {
    ...
    Member member2 = new Member("Jane", "Smith", "jane@example.com", "janesmith", "Password1!");
    ...
    System.out.println("  Found user ID 1: " + (foundById != null ? foundById.getUsername() : "null"));
    IUser notFoundById = userRegistry.searchUserById("999");
    System.out.println("  Found user ID 999: " + (notFoundById != null ? notFoundById.getUsername() : "null"));
    
    // Test searchUserByEmail
    System.out.println("\nSearch by email:");
    IUser foundByEmail = userRegistry.searchUserByEmail("john@example.com");
    System.out.println("  Found john@example.com: " + (foundByEmail != null ? foundByEmail.getUsername() : "null"));
    IUser notFoundByEmail = userRegistry.searchUserByEmail("nonexistent@example.com");
    System.out.println("  Found nonexistent@example.com: " + (notFoundByEmail != null ? notFoundByEmail.getUsername() : "null"));
    
    // Test searchUserByUsername
    System.out.println("\nSearch by username:");
    IUser foundByUsername = userRegistry.searchUserByUsername("janesmith");
    System.out.println("  Found janesmith: " + (foundByUsername != null ? foundByUsername.getUsername() : "null"));
    IUser notFoundByUsername = userRegistry.searchUserByUsername("nonexistent");
    System.out.println("  Found nonexistent: " + (notFoundByUsername != null ? notFoundByUsername.getUsername() : "null"));
    
    // Test login method
    System.out.println("\nLogin tests:");
    IUser loggedIn = userRegistry.login("john@example.com", "Password1!", users);
    System.out.println("  Login with email: " + (loggedIn != null ? loggedIn.getUsername() : "null"));
    loggedIn = userRegistry.login("johndoe", "Password1!", users);
    System.out.println("  Login with username: " + (loggedIn != null ? loggedIn.getUsername() : "null"));
    loggedIn = userRegistry.login("john@example.com", "WrongPassword!", users);
    System.out.println("  Login with wrong password: " + (loggedIn != null ? loggedIn.getUsername() : "null"));
    loggedIn = userRegistry.login("nonexistent", "Password1!", users);
    System.out.println("  Login with nonexistent user: " + (loggedIn != null ? loggedIn.getUsername() : "null"));
  ...
  public static void testTaskClass() {
    ...
    // Test constructor and getters
    Task task = new Task("Important Task", Task.TaskPriority.HIGH, deadline, "This is a test task description");
    ...
    // Test isPastDeadline
    Task pastTask = new Task("Past Task", Task.TaskPriority.LOW, LocalDate.now().minusDays(1), "Past deadline");
    System.out.println("\nPast deadline task isPastDeadline: " + pastTask.isPastDeadline());
    Task futureTask = new Task("Future Task", Task.TaskPriority.LOW, LocalDate.now().plusDays(1), "Future deadline");
    System.out.println("Future deadline task isPastDeadline: " + futureTask.isPastDeadline());
    Task nullDeadlineTask = new Task("Null Deadline Task", Task.TaskPriority.LOW, null, "No deadline");
    System.out.println("Null deadline task isPastDeadline: " + nullDeadlineTask.isPastDeadline());
  ...
  public static void testProjectClass() {
    ...
    // Test constructor and getters
    Project project = new Project("Test Project", "A test project description", owner);
    ...
    System.out.println("  Added member by ID '" + member1.getId() + "': " + added);
    ...
    System.out.println("Search member by ID: " + (foundMember != null ? foundMember.getUsername() : "null"));
    Member notFoundMember = project.searchMemberById("999");
    System.out.println("Search member by ID '999': " + (notFoundMember != null ? notFoundMember.getUsername() : "null"));
    
    // Test searchMemberByName
    foundMember = project.searchMemberByName("janesmith");
    System.out.println("Search member by username 'janesmith': " + (foundMember != null ? foundMember.getUsername() : "null"));
    notFoundMember = project.searchMemberByName("nonexistent");
    System.out.println("Search member by username 'nonexistent': " + (notFoundMember != null ? notFoundMember.getUsername() : "null"));
    
    // Test addTask
    System.out.println("\nAdding tasks:");
    project.addTask(owner, "Task 1", Task.TaskPriority.HIGH, "2026-03-15", "First task", 1);
    project.addTask(owner, "Task 2", Task.TaskPriority.MEDIUM, "2026-03-20", "Second task", 2);
    System.out.println("  Added 2 tasks, task count: " + project.getTaskCount());
    
    // Test getTask
    Task retrievedTask = project.getTask(owner, 0);
    System.out.println("  Retrieved task at index 0: " + (retrievedTask != null ? retrievedTask.getTitle() : "null"));
    ...
    System.out.println("  Members count after removal: " + project.getNumMember());
    ...
    project2.addTask(owner, "Task", Task.TaskPriority.LOW, null, "Description", 0);
    boolean denied = project2.removeTaskByIndex(member1, 0);
    System.out.println("\nMember trying to delete task (should be false): " + denied);
