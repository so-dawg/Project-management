...
public class Main {
  ...
  public static void testUserClass() {
      ...
      System.out.println(
          "  Found nonexistent@example.com: " + (notFoundByEmail != null ? notFoundByEmail.getUsername() : "null"));
      ...
      System.out
          .println("  Found nonexistent: " + (notFoundByUsername != null ? notFoundByUsername.getUsername() : "null"));
  ...
  public static void testProjectClass() {
    ...
    System.out
        .println("Search member by ID '999': " + (notFoundMember != null ? notFoundMember.getUsername() : "null"));

    // Test searchMemberByName
    foundMember = project.searchMemberByName("janesmith");
    System.out.println(
        "Search member by username 'janesmith': " + (foundMember != null ? foundMember.getUsername() : "null"));
    notFoundMember = project.searchMemberByName("nonexistent");
    System.out.println(
        "Search member by username 'nonexistent': " + (notFoundMember != null ? notFoundMember.getUsername() : "null"));
